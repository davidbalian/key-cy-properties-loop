...
class KCPF_Map_Card_Renderer
{
    ...
    public static function renderCard($property_id, $purpose = 'sale')
    {
        ...
        if ($isSale) {
            self::renderSaleCard($property_id, $location, $price, $multiUnitPrice, $cityArea, $propertyType, $isMultiUnit, $multiUnitTable, $bedrooms, $bathrooms, $totalCoveredArea, $coordinates);
        } else {
            self::renderRentCard($property_id, $location, $purposeTerms, $price, $isMultiUnit, $multiUnitCount, $bedrooms, $bathrooms, $purposeSlug, $coordinates);
        }
     ...
     */
    private static function renderSaleCard($property_id, $location, $price, $multiUnitPrice, $cityArea, $propertyType, $isMultiUnit, $multiUnitTable, $bedrooms, $bathrooms, $totalCoveredArea, $coordinates)
    {
        ?>
     ...
     */
    private static function renderRentCard($property_id, $location, $purpose, $price, $isMultiUnit, $multiUnitCount, $bedrooms, $bathrooms, $purposeSlug, $coordinates)
    {
